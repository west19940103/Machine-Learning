...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='E:\BaiduNetdiskDownload\plat\data/coco128.yaml', help='data.yaml path')
    ...
    parser.add_argument('--weights', type=str, default='E:\BaiduNetdiskDownload\plat\weights/yolov5s.pt', help='initial weights path')
