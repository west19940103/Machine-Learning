...
def detect(save_txt=False):
    ...
    if classify:
        ...
        modelc.load_state_dict(torch.load('E:\BaiduNetdiskDownload\plat\weights/Final_LPRNet_model.pth', map_location=torch.device('cpu')))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='E:\pedestrian_volume/1.avi', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--output', type=str, default='E:\pedestrian_volume/output1', help='output folder')  # output folder
